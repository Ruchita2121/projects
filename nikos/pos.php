...
<div class="col-lg-2">
  <div class="card mb-3">
    <div class="card-body">
      <form method="post" action="pos.php?action=add&id=<?php echo $row["ProductCode"] ?>">
         <img src="theme/carousel/ab.jpg" alt="..." style="width:100%"> 
         <h4 class="text-info"><?php echo $row["Product_Name"]; ?> (<?php echo $row["Onhand"]; ?>)</h4>
         <h4 class="text-danger">&#8369 <?php echo $row["Selling_price"]; ?></h4>
