 ...
 <div class="container--head">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="theme/carousel/b7.jpg" alt="..." style="width:100%">
        <div class="carousel-caption">
          <h3></h3> 
        </div>
      </div>
      <div class="item">
        <img src="theme/carousel/b9.jpg" alt="..." style="width:100%">
        <div class="carousel-caption">
          <h3></h3> 
        </div>
      </div>
      <div class="item">
        <img src="theme/carousel/front.jpg" alt="..." style="width:100%">
        <div class="carousel-caption">
          <h3></h3> 
        </div>
      </div>
