    ...
    <!--bof main content-->
      <div class="mainbar">
        <div class="article">
          ...
          <p>
		  <?php
  $q = mysql_query("select * from shopcart where shopcart_usercookie = '".$_SESSION['email']."'");
  $r = mysql_num_rows($q);
  if($_SESSION['email'] == '') { ?>
  <!-- Added Code -->
   
   Please login to continue shopping.</p>
 <p>or If not registered with us please sign up to enjoy our services.</p>
 <table width="146" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <th width="146" height="60" align="left" valign="top" scope="col"><ul class="style3">
       <li><a href="index.php">Login</a></li>
       <li><a href="ClientRegistration.php">Sign up</a></li>
     </ul></th>
   </tr>
 </table>
 <p>
