...
if ((isset($_GET['CatID'])) && ($_GET['CatID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM category WHERE CatID=%s",
...
if (isset($_GET['CatID'])) {
  $colname_rsCategory = $_GET['CatID'];
}
mysql_select_db($database_db52417, $db52417);
$query_rsCategory = sprintf("SELECT * FROM category WHERE CatID = %s", GetSQLValueString($colname_rsCategory, "int"));
...
<!--eof header-->
  <div class="content">
    ...
    <!--bof main content-->
      <div class="mainbar">
        <div class="article">
          <h2><span>Delete Category.</span></h2>
          <p>&nbsp;</p>
